...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 min-h-screen bg-gradient-to-b from-white to-slate-50 border-r border-slate-200 px-6 py-8 shadow-xl">
      {/* Header */}
      <div className="mb-10">
        ...
        <p className="text-sm text-slate-500 font-medium ml-11">Management System</p>
      </div>
